...
urlpatterns = [
    ...
    path('register2/', views.register2, name='registro2'), #Registrar un usuario si no existe en la DB
    ...
    path('api/routes2/', views.consultar_rutas2, name='consultar_rutas2'),#Consultar rutas de autobus | pasajero y operadores logisticos
